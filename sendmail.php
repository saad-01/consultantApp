    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        if (!empty($email)) {
            ...
            if ($email) {
                ...
                $transport = (new Swift_SmtpTransport('smtp.gmail.com', 587, 'tls')) // Use port 587 for TLS
                    ->setUsername('m.saadashraf286@gmail.com')
                    ->setPassword('tpasfbvguczxgrcc');
                ...
                $message = (new Swift_Message('Wonderful Subject'))
                    ->setFrom(['m.saadashraf286@gmail.com' => 'Future Advisers'])
                    ->setTo($to)
                               ...
                               <br>
                                           <table class="col387" align="center" border="0" cellpadding="0" cellspacing="0" style= "width: auto">
                                                   ...
                                                   <th style="padding: 0 0 10px 0; color: #5945b2; text-align: left; font-family: Arial, sans-serif; font-size: 24px;width: 150px; line-height: 24px;">OTP CODE :</th>
                                                    <td style="padding: 0 0 10px 0; color: #44ca35; text-align: left; font-family: Arial, sans-serif; font-size: 28px;width: 150px; line-height: 24px;"> <b>001122</b></td>
                                                    </tr>
